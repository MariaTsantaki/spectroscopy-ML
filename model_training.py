...
class Data:
    ...
    def _prepare_data(self):
        ...
        if self.with_quadratic_terms:
            ...
            #self.xlabel = ['teff', 'logg', 'feh', 'alpha', 'teff**2', 'logg**2', 'feh**2', 'teff*logg', 'teff*feh', 'logg*feh']
    ...
    def feature_selection_best(self, k=5):
        ...
        for i in range(2400):
            ...
            print(names)
            #print(zip(selector.get_support(), feature_names))

    def feature_selection_percentile(self, percentile=20):
        feature_names = ['teff', 'logg', 'feh', 'alpha', 'teff**2', 'logg**2', 'feh**2', 'alpha**2', 'teff*logg', 'teff*feh', 'logg*feh', 'teff*alpha', 'alpha*feh', 'logg*alpha']
        y = self.y.values
        totalscore = []
...
class Model:
    ...
    def _get_label_vector(self, p):
        ...
        if self.data.with_quadratic_terms:
            #v += [teff**2.0, logg**2.0, feh**2.0, teff*logg, teff*feh, logg*feh]
